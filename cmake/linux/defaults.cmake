...
set(_package_system_name "${CMAKE_C_LIBRARY_ARCHITECTURE}")
if(PLUGIN_LINUX_DISTRIBUTION_VERSION)
  string(APPEND _package_system_name "-ubuntu-${PLUGIN_LINUX_DISTRIBUTION_VERSION}")
endif()
set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${CPACK_PACKAGE_VERSION}-${_package_system_name}")
